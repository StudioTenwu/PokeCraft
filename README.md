...
|       _Describe your dream Pokémon to start the creation process_       |           _Avatar generation creates your Pokémon's appearance_           |        _Your Pokémon gets personality traits and a backstory_         |
...
|   _Create 2D worlds with terrain, items, and obstacles_   |   _Teach your Pokémon custom tools through descriptions_   |  _Your Pokémon explores the world using the tools you built_   |
