...
class ToolGenerator:
    ...
    async def generate_tool(self, description: str, agent_id: str) -> ToolCode:
        ...
        """
        logger.info(f"Generating tool for agent {agent_id} from description: {description[:50]}...")
...
5. Keep it simple and safe for children
6. NO forbidden imports: os, subprocess, sys, importlib, eval, exec
7. The function name must match the tool_name in the @tool decorator
