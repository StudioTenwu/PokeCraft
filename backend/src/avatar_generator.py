...
class AvatarGenerator:
    ...
    def generate_avatar(self, agent_id: str, prompt: str) -> str:
        ...
        enhanced_prompt = f"{prompt}, Pokemon trading card illustration, hand-drawn digital art, glossy finish, vibrant saturated colors, cute character design, centered composition, professional game art"
